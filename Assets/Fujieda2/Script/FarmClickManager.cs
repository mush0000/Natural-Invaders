...
public class FarmClickManager : MonoBehaviour
{
    ...
    {
        if (seeds != null)//キャラを選択中なら処理を行う
        {
            if (seeds.field != true) return;//種が植えてあるなら処理を行わない
            seeds.field = true;//種を植えたことにする
